...
function LoginPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      toast.success("Successfully signed in! Welcome to MY EV SERVICE Dashboard.");
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-[#040605] p-12 flex-col justify-between overflow-hidden select-none border-r border-white/10">
        ...
        <div className="relative z-10 max-w-lg space-y-6 my-auto">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#00D084]/15 border border-[#00D084]/30 text-xs font-mono font-bold text-[#00D084]">
            ...
            <span>EV Diagnostics &amp; Fleet Intelligence</span>
          </div>
          ...
          <p className="text-sm sm:text-base text-white/70 font-light leading-relaxed">
            Automated cell voltage balancing, real-time BMS health logging, and certified doorstep technician booking that keeps your electric fleet operating at peak efficiency.
          </p>
        ...
        <div className="max-w-md w-full mx-auto space-y-8 my-auto py-8">
          ...
          <div className="space-y-2">
            ...
            <p className={`text-xs sm:text-sm font-normal ${isDark ? "text-white/60" : "text-slate-500"}`}>
              Sign in to inspect your EV service &amp; diagnostic dashboard
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full rounded-full pl-11 pr-4 py-3.5 text-xs transition-all focus:outline-none focus:border-[#00D084] ${
                    isDark
            ...
            <div className="space-y-1.5">
              <div className="flex items-center justify-between">
                <label className={`text-xs font-semibold ${isDark ? "text-white/80" : "text-slate-700"}`}>
                  Password
                </label>
                <a
                  href="/feedback"
                  className="text-xs font-semibold text-[#00D084] hover:underline"
                >
                  Forgot password?
                </a>
              </div>
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full rounded-full pl-11 pr-11 py-3.5 text-xs transition-all focus:outline-none focus:border-[#00D084] ${
                    isDark
                      ? "bg-[#0f1411] border border-white/15 text-white placeholder:text-white/40 focus:bg-[#141b17]"
                      : "bg-slate-50 border border-slate-200 text-slate-900 placeholder:text-slate-400 focus:bg-white"
                  }`}
            ...
            <button
              ...
              className="w-full py-4 rounded-full bg-[#00D084] hover:bg-[#00e08f] text-[#020403] font-extrabold text-xs uppercase tracking-wider transition-all cursor-pointer flex items-center justify-center gap-2"
            >
              {isSubmitting ? (
                <span>Signing In...</span>
              ) : (
                <span>Sign In to MY EV SERVICE</span>
              )}
            </button>
          </form>
