...
export const DEFAULT_CITY_SLOTS: Record<string, PreBookingSlot[]> = {
  pune: [
    ...
    { id: "pn-9", area: "Koregaon Park", pincode: "411001", status: "available" },
    { id: "pn-10", area: "Kothrud", pincode: "411038", status: "booked" },
    { id: "pn-11", area: "Mundhwa", pincode: "411036", status: "available" },
    { id: "pn-12", area: "Shivajinagar", pincode: "411005", status: "available" },
    { id: "pn-13", area: "Sinhagad Road", pincode: "411041", status: "booked" },
    { id: "pn-14", area: "Viman Nagar", pincode: "411014", status: "available" },
    { id: "pn-15", area: "Wakad", pincode: "411057", status: "booked" },
    { id: "pn-16", area: "Warje", pincode: "411058", status: "available" },
  ],
  mumbai: [
